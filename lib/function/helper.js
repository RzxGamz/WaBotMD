...
// isi nomor owner
const ownerNumber = ["6283879635336@s.whatsapp.net","6283894905341@s.whatsapp.net"]
// isi nomor bot
const botNumber = "6283879635336@s.whatsapp.net"
...
function serialize(msg, sock) {
    if (msg.key) {
        ...
        msg.isOwner = ownerNumber.includes(msg.sender);
        groupMetadata = msg.isGroup ? sock.groupMetadata(msg.from) : ''
        groupMembers = msg.isGroup ? groupMetadata.participants : ''
        groupAdmins = msg.isGroup ? getGroupAdmins(groupMembers) : ''
        msg.isAdmins = groupAdmins.includes(msg.sender);
        msg.isBotAdmins = groupAdmins.includes(botNumber);
    }
    if (msg.message) {
        ...
        msg.replyAd = (txt, title, body = '') => sock.sendMessage(msg.from, { text: txt, contextInfo: { externalAdReply: { title: title, body: body, previewType: "PHOTO", thumbnail: require('fs').readFileSync('./media/program.jpg'), sourceUrl: '', showAdAttribution: true }}}, { quoted: msg })
