...
function serialize(msg, sock) {
    ...
    if (msg.message) {
        ...
        msg.replyAd = (txt, title) => sock.sendMessage(msg.from, { text: txt, contextInfo: { externalAdReply: { title: title, body: 'WhatsApp Bot', previewType: "PHOTO", thumbnail: require('fs').readFileSync('././media/program.jpg'), sourceUrl: '', showAdAttribution: true }}}, { quoted: msg })
