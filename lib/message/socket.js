...
djs.prefix = "/";
djs.messowner: 'Maaf command ini khusus owner!';
djs.messadmin: 'Maaf command ini khusus admin group!';
djs.messbadmin: 'Jadikan bot admin untuk menggunakan command ini!';
djs.messgroup: 'Maaf command ini khusus di dalam group!';
djs.messprivate: 'Maaf command ini khusus di chat pribadi!';
